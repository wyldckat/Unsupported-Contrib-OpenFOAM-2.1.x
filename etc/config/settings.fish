...
prependToVar PATH $FOAM_USER_APPBIN $FOAM_SITE_APPBIN $FOAM_APPBIN

# Make sure to pick up dummy versions of external libraries last
prependToVar LD_LIBRARY_PATH $FOAM_USER_LIBBIN $FOAM_SITE_LIBBIN $FOAM_LIBBIN $FOAM_EXT_LIBBIN $FOAM_LIBBIN/dummy
